...
public class Unsigned16 implements Writable {
   ...
   * detected and the result is the low 16 bytes of the result. The numbers are
   * divided into 32 and 31 bit chunks so that the product of two chucks fits in
   * the unsigned 63 bits of a long.
   * 
  ...
  /**
   * Shift the number a given number of bit positions. The number is the low order
   * bits of the result.
   * 
