...
public class DataInputFormat extends FileInputFormat<Text, Text> {
    ...
    static class TextSampler implements IndexedSortable {
        ...
        /**
         * Find the split points for a given sample. The sample keys are sorted and down
         * sampled to find even split points for the partitions. The returned keys
         * should be the start of their respective partitions.
         * 
     ...
     * By default reads 100,000 keys from 10 locations in the input, sorts them and
     * picks N-1 keys to generate N equally sized partitions.
     * 
